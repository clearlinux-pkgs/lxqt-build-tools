...
Version  : 0.9.0
Release  : 5
URL      : https://github.com/lxqt/lxqt-build-tools/releases/download/0.9.0/lxqt-build-tools-0.9.0.tar.xz
Source0  : https://github.com/lxqt/lxqt-build-tools/releases/download/0.9.0/lxqt-build-tools-0.9.0.tar.xz
Source1  : https://github.com/lxqt/lxqt-build-tools/releases/download/0.9.0/lxqt-build-tools-0.9.0.tar.xz.asc
...
%prep
%setup -q -n lxqt-build-tools-0.9.0
cd %{_builddir}/lxqt-build-tools-0.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618499121
mkdir -p clr-build
pushd clr-build
